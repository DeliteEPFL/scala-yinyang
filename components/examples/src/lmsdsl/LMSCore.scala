package scala.virtualization.lms.yinyang

import scala.virtualization.lms.common._
import scala.virtualization.lms.internal._
import scala.virtualization.lms.util.OverloadHack
import ch.epfl.yinyang.api.BaseYinYangManifest
import org.scala_lang.virtualized.SourceContext
import ch.epfl.yinyang.example.{ PolymorphicBaseManifest, Base }

//different Base than LMS!
...
//example DSL
//TO me this seems very similar to the general design of LMS with IntOps and IntOpsExp
...
//knowing lms it would have been nice to use a different name than "Base"...
//TypeRep is a confusing name considering the usage of "Rep" is LMS
trait LMSYinYang
  extends PolymorphicBaseManifest //LMS uses polymorphic types rather than custom types
  with scala.virtualization.lms.common.BaseExp {
  self =>
  type R[+T] = Rep[T] //LMS internal polymorphic representation
