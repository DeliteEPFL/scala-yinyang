...
trait DateOps extends Base {
  ...
  class DateRepOps(d: Rep[Date]) {
    ...
    def -(years: Rep[Int], months: Rep[Int], days: Rep[Int]): Rep[Date] =
      dateRemove(d, years, months, days)
  }
  ...
  def dateRemove(d: Rep[Date], years: Rep[Int], months: Rep[Int], days: Rep[Int]): Rep[Date]
}
...
trait DateOpsExp extends DateOps with BaseExp {
  ...
  case class DateRemove(d: Rep[Date], years: Rep[Int], months: Rep[Int], days: Rep[Int]) extends Def[Date]
